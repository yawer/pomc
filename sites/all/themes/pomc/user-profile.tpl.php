...
<div class="user-profile clearfix">
		...
		<?php endif; ?>
                    ...
                    <div class="single-stat"><a href="#"><span class="stat-no"> <?php $follow = flag_get_flag('follow_users'); print l( $follow->get_count($elements['#account']->uid).' following', "user/".$elements['#account']->uid."/followers"); ?> </span></div>
