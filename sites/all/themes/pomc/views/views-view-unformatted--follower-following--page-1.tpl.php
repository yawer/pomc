...
<div class="user-profile profile-follower-page clearfix">
                ...
                print theme('image_style', array('style_name' => 'profile-picture', 'path' => $user_profile->field_profile_pic['und'][0]['uri'], 'alt' => $user_profile->name, 'title' => $user_profile->name));?>
                <div><ul class = "extra-links"><li class= "extra-link-list"><?php print l("Send message", 'messages/new/'.$user_id); ?></li>
...
<div class = "follow-container">
 <div class="follow-title"> <?php $follow = flag_get_flag('follow_users'); print $follow->get_user_count($user_id) . t(' Following')?> </div>
